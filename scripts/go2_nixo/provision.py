...
def build_payload(
    ...
    doc["hit"] = {
        ...
        "piezo_ao_threshold_raw": env_int(env, prefixed_tuning_keys("PIEZO_AO_THRESHOLD_RAW"), 2400),
        "piezo_ao_rearm_raw": env_int(env, prefixed_tuning_keys("PIEZO_AO_REARM_RAW"), 1800),
