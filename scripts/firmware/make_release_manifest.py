...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a BattleBang firmware release manifest.")
    ...
    parser.add_argument("--app", default="battlebang-hit-target")
    parser.add_argument("--hardware", default="esp32dev-hit-target-ring-v1")
