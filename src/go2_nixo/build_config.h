...
#ifdef BATTLEBANG_BUILD_NIXO_SERVO_PIN
#undef BATTLEBANG_NIXO_SERVO_PIN
#define BATTLEBANG_NIXO_SERVO_PIN BATTLEBANG_BUILD_NIXO_SERVO_PIN
#endif
...
#ifndef BATTLEBANG_NIXO_SERVO_PIN
#define BATTLEBANG_NIXO_SERVO_PIN 18
#endif
...
static constexpr int NIXO_SERVO_PIN_VALUE = BATTLEBANG_NIXO_SERVO_PIN;
static constexpr int NIXO_FIRE_POS_A = 55;
static constexpr int NIXO_FIRE_POS_B = 145;
static constexpr int NIXO_SERVO_INITIAL_POS = 125;
static constexpr int NIXO_SERVO_STEP = 2;
static constexpr uint32_t NIXO_SERVO_STEP_DT_MS = 15;
