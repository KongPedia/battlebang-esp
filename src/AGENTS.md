...
- Versioned release tags (`hit-target-v{version}`, `turret-fleet-v{version}`) remain immutable audit points. Stable tags are for polling manifests and should not overwrite another firmware family.
